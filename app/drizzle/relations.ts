...
import { country, learner, course, booking, payments, currency, tenants, programmes, accommodation, attendanceDay, attendanceMark, courses, users, classes, classSessions, attendance, assignments, submissions, enrollments, grades, enrollmentAmendments, lessonPlans, auditLog, feedback } from "./schema";
