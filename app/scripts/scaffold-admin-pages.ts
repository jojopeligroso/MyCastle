...
const pages = [
    ...
    { path: 'classes', title: 'Class & Cohort Management', desc: 'Manage academic classes and cohorts' },
    ...
    { path: 'progress', title: 'Progress and CEFR Tracking', desc: 'Monitor student academic progress' },

    // Compliance
    { path: 'compliance/visa', title: 'Visa and Immigration Compliance', desc: 'Track visa status and compliance requirements' },
    { path: 'compliance/regulatory', title: 'Regulatory Reporting', desc: 'Generate regulatory reports' },
    ...
    // System & Settings
    { path: 'communications/notifications', title: 'Notifications and Messaging', desc: 'Manage system alerts and messages' },
    ...
    { path: 'integrations', title: 'Integrations', desc: 'Manage external integrations', restricted: true },
    { path: 'policies', title: 'Access Policies', desc: 'Configure RBAC and policies', restricted: true },
