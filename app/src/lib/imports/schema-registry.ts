...
export const IMPORTABLE_FIELDS: ImportableField[] = [
  ...
  },
  {
    ...
    table: 'enrollments',
    type: 'string',
    aliases: ['Placement Test Score', 'Placement Test', 'Placement Score', 'Test Score', 'Entry Level'],
    required: false,
    editable: true,
  },
  ...
  // ============================================
  {
    ...
    table: 'enrollments',
    type: 'boolean',
    aliases: ['Include On Register', 'On Register', 'Register', 'XXX', 'XXX Counter', 'Register Flag'],
    required: false,
    editable: true,
  },
];
