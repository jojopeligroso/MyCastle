      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-16 sm:py-24 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
            The modern operations platform for ESL schools. Streamline lesson planning, attendance
            tracking, and student progress management with AI-assisted workflows.
          </p>
        ...
        <div className="py-16 sm:py-20">
          ...
          <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Built for teachers, students, and administrators with security and compliance at its
            core.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">AI Lesson Planner</h3>
              <p className="text-gray-600">
                Generate CEFR-aligned lesson plans in minutes with AI assistance. Save hours of
                preparation time while maintaining quality standards.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fast Attendance Marking</h3>
              <p className="text-gray-600">
                Mark attendance in under 2 minutes with keyboard-first UI. Immutable audit trail
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Timetable Management</h3>
              <p className="text-gray-600">
                Organize class schedules, manage rooms and resources. Students and teachers always
                know what&apos;s next.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Student Progress</h3>
              <p className="text-gray-600">
                Track student progress against CEFR standards. Generate insights and help learners
                achieve their goals.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                Context-aware automation through role-specific MCP servers. Let AI handle routine
                tasks while you focus on teaching.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                ISO 27001/27002 aligned with GDPR compliance. Multi-tenant architecture with
        ...
        <div className="py-16 sm:py-20">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-12 text-center shadow-xl">
            ...
            <p className="text-indigo-100 text-lg mb-8 max-w-2xl mx-auto">
              Join modern ESL schools using MyCastle to save time, improve compliance, and enhance
