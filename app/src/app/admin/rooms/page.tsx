 ...
 * This page requires a 'rooms' table to be created.
 * See: spec/01-admin-mcp.md §1.2.3
 */
    ...
    <div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The <code className="bg-yellow-100 px-1 py-0.5 rounded">rooms</code> table
              ...
              <ul className="list-disc list-inside mt-1 space-y-1">
                ...
                <li>equipment (jsonb) - Available resources {"{"}"projector": true, "computers": 15{"}"}</li>
      ...
      <div className="bg-white rounded-lg shadow p-8 text-center">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Database schema needs to be created before rooms can be managed.
        </p>
        <div className="mt-6">
          <Link
            href="/admin"
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ol className="mt-2 text-sm text-blue-800 list-decimal list-inside space-y-1">
          <li>Create migration for <code>rooms</code> table</li>
          <li>Run migration: <code className="bg-blue-100 px-1 py-0.5 rounded">npm run db:migrate</code></li>
          <li>Add schema to <code>app/src/db/schema/facilities.ts</code></li>
          <li>Create CRUD pages (list, create, edit, view)</li>
          <li>Implement MCP tools: <code>create_room</code>, <code>check_room_availability</code></li>
        </ol>
      </div>
    </div>
  );
