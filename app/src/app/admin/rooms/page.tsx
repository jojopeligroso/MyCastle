    ...
    <div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The <code className="bg-yellow-100 px-1 py-0.5 rounded">rooms</code> table needs to
                be created in the database schema.
              </p>
              <p className="mt-2">
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ol className="mt-2 text-sm text-blue-800 list-decimal list-inside space-y-1">
          <li>
            Create migration for <code>rooms</code> table
          </li>
          <li>
            Run migration:{' '}
          ...
          <li>
            Add schema to <code>app/src/db/schema/facilities.ts</code>
          </li>
          <li>Create CRUD pages (list, create, edit, view)</li>
          <li>
            Implement MCP tools: <code>create_room</code>, <code>check_room_availability</code>
          </li>
        </ol>
      </div>
    </div>
