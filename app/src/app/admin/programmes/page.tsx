/**
 * Programmes List Page - View and manage academic programmes
 * MCP Resource: admin://programmes
 *
 * ⚠️ DATABASE SCHEMA MISSING
 * This page requires a 'programmes' table to be created.
...
export default async function ProgrammesPage() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Academic Programmes</h1>
        <p className="mt-2 text-gray-600">Manage programmes and pathways</p>
      </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The <code className="bg-yellow-100 px-1 py-0.5 rounded">programmes</code> table
      ...
      <div className="bg-white rounded-lg shadow p-8 text-center">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Database schema needs to be created before programmes can be managed.
        </p>
        <div className="mt-6">
          <Link
            href="/admin"
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ol className="mt-2 text-sm text-blue-800 list-decimal list-inside space-y-1">
          <li>Create migration for <code>programmes</code> table</li>
          <li>Run migration: <code className="bg-blue-100 px-1 py-0.5 rounded">npm run db:migrate</code></li>
          <li>Add schema to <code>app/src/db/schema/academic.ts</code></li>
          <li>Create CRUD pages (list, create, edit, view)</li>
          <li>Implement MCP tools: <code>create_programme</code>, <code>publish_syllabus</code></li>
        </ol>
      </div>
    </div>
  );
