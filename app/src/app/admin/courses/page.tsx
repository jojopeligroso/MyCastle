    ...
    <div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The <code className="bg-yellow-100 px-1 py-0.5 rounded">courses</code> table
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ol className="mt-2 text-sm text-blue-800 list-decimal list-inside space-y-1">
          <li>Create migration for <code>courses</code> table</li>
          ...
          <li>Implement MCP tools: <code>create_course</code>, <code>update_course</code></li>
        </ol>
      </div>
    </div>
  );
