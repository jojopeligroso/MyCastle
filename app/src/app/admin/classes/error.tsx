...
export default function ClassesError({
  ...
  useEffect(() => {
    console.error('[Classes Module Error]', error);
  }, [error]);
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Classes Module Error</h3>
          <p className="text-sm text-gray-600">Failed to load class information</p>
        </div>
      </div>
