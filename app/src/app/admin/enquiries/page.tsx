    ...
    <div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The <code className="bg-yellow-100 px-1 py-0.5 rounded">enquiries</code> table needs
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ol className="mt-2 text-sm text-blue-800 list-decimal list-inside space-y-1">
          <li>
            Create migration for <code>enquiries</code> table
          </li>
          <li>
            Run migration:{' '}
          ...
          <li>
            Add schema to <code>app/src/db/schema/enquiries.ts</code>
          </li>
          <li>Create CRUD pages (list, create, edit, view)</li>
          <li>
            Implement MCP tools: <code>create_enquiry</code>, <code>update_enquiry_status</code>,{' '}
            <code>convert_to_booking</code>
          </li>
        </ol>
      </div>
    </div>
