            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-md">
                <ul className="divide-y divide-gray-200">
                    {sessions.map((session) => {
                        ...
                        const statusColor = isReported ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800';
                                    ...
                                    <div className="px-4 py-4 sm:px-6">
                                        <div className="flex items-center justify-between">
                                            <div className="text-sm font-medium text-purple-600 truncate">
                                                {session.className} <span className="text-gray-500">({session.classCode})</span>
                                            </div>
