                                ...
                                <div className="flex items-center space-x-2">
                                    {statuses.map(status => (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-full text-xs font-medium capitalize transition-colors border ${current.status === status
                                                ? status === 'present' ? 'bg-green-100 text-green-800 border-green-200 ring-2 ring-green-500'
                                                    : status === 'absent' ? 'bg-red-100 text-red-800 border-red-200 ring-2 ring-red-500'
                                                        : status === 'late' ? 'bg-yellow-100 text-yellow-800 border-yellow-200 ring-2 ring-yellow-500'
