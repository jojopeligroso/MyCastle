      ...
      <section>
        ...
        <div className="bg-gray-50 rounded-lg p-8 text-center">
          ...
          <p className="mt-1 text-xs text-gray-500">
            This feature will display admin notes about the student
          </p>
        </div>
      </section>
      ...
      {!canViewSensitiveNotes && (
        <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
          <p className="text-xs text-amber-800">
            <strong>Note:</strong> You do not have permission to view or add sensitive student
            notes. Only Directors of Studies and Administrators can access this information for
